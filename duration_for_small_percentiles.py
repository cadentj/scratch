...
# Load data
with open('duration-p90-p100.json', 'r') as f:
    data = json.load(f)
...
# Convert percentile labels to numeric (e.g., "p90.0" -> 90.0, "p90.5" -> 99.5)
percentiles = [float(p[1:]) for p in percentile_labels]
...
ax.set_title('Request Runtime Distribution (p90-p100)', fontsize=12)
...
# Print summary
print("\n" + "=" * 50)
print("RUNTIME PERCENTILES SUMMARY (p90-p100)")
print("=" * 50)
