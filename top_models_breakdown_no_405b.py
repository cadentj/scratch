...
ax1.set_title('Memory Required (6h TTL) - By Top N Models (excluding 405b)')
...
ax2.set_title('Total Requests (6h Rolling) - By Top N Models (excluding 405b)')
...
ax3.set_title('Unique Models Active (6h Rolling) - By Top N Models (excluding 405b)')
ax3.set_xlabel('Time')
...
output_file = 'top_models_breakdown_no_405b.png'
...
print("\n" + "="*60)
print("SUMMARY: 6h Rolling Window by Top N Models (excluding 405b)")
print("="*60)
